 ...
 * index 4: Có 1 cái màu vàng tương ứng indexStar 0 đều màu vàng
 *
 * ta nhận ra là indexStar < 5 - index => màu vàng
 */
  ...
  const handleFilterStar = (ratingFilter: number) => {
    navigate({
      ...
      search: createSearchParams({
        ...queryConfig,
        // http://localhost:3000/?page=1&limit=20&rating_filter=...
